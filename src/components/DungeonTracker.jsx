...
const DUNGEONS = [
  ...
  },
  {
    ...
    scryfallUrl: 'https://api.scryfall.com/cards/tafr/22', scryfallSet: 'tafr',
  ...
  },
  {
    ...
    scryfallUrl: 'https://api.scryfall.com/cards/tclb/0', scryfallSet: 'tclb',
    startRoom: 'crash-landing',
    rooms: {
      'crash-landing':    { name: 'Crash Landing',     effect: 'Search your library for a basic land card, reveal it, put it into your hand, then shuffle', next: ['goblin-camp', 'emerald-grove'] },
      'goblin-camp':      { name: 'Goblin Camp',       effect: 'Create a Treasure token',                                                               next: ['aunties-teahouse', 'defiled-temple'] },
      'emerald-grove':    { name: 'Emerald Grove',     effect: 'Create a 2/2 white Knight creature token',                                              next: ['mountain-pass', 'ebonlake-grotto'] },
      'aunties-teahouse': { name: "Auntie's Teahouse", effect: 'Scry 3',                                                                                next: ['grymforge'] },
      'defiled-temple':   { name: 'Defiled Temple',    effect: 'You may sacrifice a permanent. If you do, draw a card',                                 next: ['githyanki-creche'] },
      'mountain-pass':    { name: 'Mountain Pass',     effect: 'You may put a land card from your hand onto the battlefield',                            next: ['last-light-inn'] },
      'ebonlake-grotto':  { name: 'Ebonlake Grotto',   effect: 'Create two 1/1 blue Faerie Dragon creature tokens with flying',                         next: ['reithwin-tollhouse'] },
      'grymforge':        { name: 'Grymforge',         effect: 'For each opponent, goad up to one target creature that player controls',                 next: ['moonrise-towers'] },
      'githyanki-creche': { name: 'Githyanki Crèche',  effect: 'Distribute three +1/+1 counters among up to three target creatures you control',         next: ['gauntlet-of-shar'] },
      'last-light-inn':   { name: 'Last Light Inn',    effect: 'Draw two cards',                                                                        next: ['balthazars-lab'] },
      'reithwin-tollhouse': { name: 'Reithwin Tollhouse', effect: 'Roll 2d4 and create that many Treasure tokens',                                     next: ['balthazars-lab'] },
      'moonrise-towers':  { name: 'Moonrise Towers',   effect: 'Instant and sorcery spells you cast this turn cost {3} less to cast',                   next: ['balthazars-lab'] },
      'gauntlet-of-shar': { name: 'Gauntlet of Shar',  effect: 'Each opponent loses 5 life',                                                            next: ['balthazars-lab'] },
      'balthazars-lab':   { name: "Balthazar's Lab",   effect: 'Return up to two target creature cards from your graveyard to your hand',               next: [] },
    },
  },
