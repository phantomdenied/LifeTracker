...
const DUNGEONS = [
  {
    ...
    areas: {
      ...
      'deep-mines': { x: 10.0, y: 68.8, w: 83.4, h: 5.8 },
      'mad-wizards-lair': { x: 9.7, y: 76.4, w: 83.0, h: 8.6 },
  ...
  },
  {
    ...
    areas: {
      ...
      'last-light-inn': { x: 8.9, y: 50.0, w: 39.4, h: 6.5 },
      'reithwin-tollhouse': { x: 52.0, y: 50.0, w: 39.2, h: 6.5 },
      'moonrise-towers': { x: 8.8, y: 58.2, w: 23.8, h: 6.2 },
      'gauntlet-of-shar': { x: 36.6, y: 58.2, w: 27.6, h: 6.2 },
      'balthazars-lab': { x: 67.0, y: 58.2, w: 22.8, h: 6.2 },
      'circus-of-the-last-days': { x: 8.8, y: 66.4, w: 39.2, h: 6.3 },
      'undercity-ruins': { x: 52.0, y: 66.4, w: 39.2, h: 6.3 },
      'steel-watch-foundry': { x: 8.8, y: 74.6, w: 23.8, h: 12.0 },
      'ansurs-sanctum': { x: 36.2, y: 74.6, w: 28.2, h: 12.0 },
      'temple-of-bhaal': { x: 67.0, y: 74.6, w: 22.8, h: 12.0 },
