...
const DUNGEONS = [
  {
    ...
    areas: {
      'yawning-portal': { x: 4.8, y: 13.6, w: 90.4, h: 9.2 },
      'dungeon-level': { x: 4.8, y: 24.2, w: 90.4, h: 8.4 },
      'goblin-bazaar': { x: 5.0, y: 33.7, w: 42.6, h: 14.0 },
      'twisted-caverns': { x: 50.4, y: 33.7, w: 42.6, h: 14.0 },
      'lost-level': { x: 4.8, y: 49.6, w: 90.4, h: 6.7 },
      'runestone-caverns': { x: 5.0, y: 58.0, w: 42.6, h: 16.2 },
      'muirals-graveyard': { x: 50.4, y: 58.0, w: 42.6, h: 16.2 },
      'deep-mines': { x: 4.8, y: 76.0, w: 90.4, h: 7.5 },
      'mad-wizards-lair': { x: 4.8, y: 84.8, w: 90.4, h: 10.0 },
    },
  },
  {
    id: 'phandelver',
    ...
    areas: {
      'cave-entrance': { x: 4.8, y: 13.8, w: 90.4, h: 13.8 },
      'goblin-lair': { x: 5.0, y: 29.7, w: 42.8, h: 15.4 },
      'mine-tunnels': { x: 50.2, y: 29.7, w: 42.8, h: 15.4 },
      'storeroom': { x: 5.0, y: 47.7, w: 24.0, h: 20.0 },
      'dark-pool': { x: 34.2, y: 47.7, w: 29.8, h: 20.0 },
      'fungi-cavern': { x: 69.0, y: 47.7, w: 24.0, h: 20.0 },
      'temple-of-dumathoin': { x: 4.8, y: 72.0, w: 90.4, h: 13.8 },
    },
  },
  {
    id: 'undercity',
    ...
    areas: {
      'secret-entrance': { x: 4.8, y: 13.9, w: 90.4, h: 15.2 },
      'forge': { x: 5.0, y: 31.0, w: 36.0, h: 11.4 },
      'lost-well': { x: 58.0, y: 31.0, w: 35.0, h: 11.4 },
      'trap': { x: 5.0, y: 43.2, w: 26.5, h: 12.8 },
      'arena': { x: 38.0, y: 42.0, w: 18.8, h: 18.0 },
      'stash': { x: 61.5, y: 43.2, w: 27.0, h: 12.8 },
      'archives': { x: 5.0, y: 57.5, w: 39.8, h: 12.8 },
      'catacombs': { x: 49.5, y: 57.5, w: 43.5, h: 12.8 },
      'throne': { x: 4.8, y: 72.6, w: 90.4, h: 16.0 },
    },
  },
  {
    ...
    areas: {
      'trapped-entry': { x: 4.8, y: 13.8, w: 90.4, h: 15.0 },
      'veils-of-fear': { x: 5.0, y: 30.8, w: 42.8, h: 19.5 },
      'oubliette': { x: 50.2, y: 30.8, w: 42.8, h: 30.8 },
      'sandfall-cell': { x: 5.0, y: 52.4, w: 42.8, h: 16.8 },
      'cradle-of-the-death-god': { x: 4.8, y: 72.0, w: 90.4, h: 13.8 },
    },
  },
  {
    ...
    rooms: {
      ...
      'grymforge': { name: 'Grymforge', effect: 'For each opponent, goad up to one target creature that player controls', next: ['last-light-inn', 'reithwin-tollhouse'] },
    ...
    areas: {
      'crash-landing': { x: 4.2, y: 10.2, w: 91.6, h: 10.8 },
      'goblin-camp': { x: 4.6, y: 22.6, w: 28.8, h: 8.4 },
      'emerald-grove': { x: 35.0, y: 22.6, w: 29.0, h: 8.8 },
      'aunties-teahouse': { x: 66.8, y: 22.6, w: 26.4, h: 8.8 },
      'defiled-temple': { x: 4.4, y: 32.8, w: 42.8, h: 8.8 },
      'mountain-pass': { x: 49.8, y: 32.8, w: 43.2, h: 8.8 },
      'ebonlake-grotto': { x: 4.6, y: 43.6, w: 27.8, h: 10.0 },
      'grymforge': { x: 35.0, y: 43.6, w: 29.0, h: 10.0 },
      'githyanki-creche': { x: 66.8, y: 43.6, w: 26.4, h: 10.0 },
      'last-light-inn': { x: 20.8, y: 55.0, w: 29.4, h: 8.0 },
      'reithwin-tollhouse': { x: 52.8, y: 55.0, w: 38.2, h: 8.0 },
      'moonrise-towers': { x: 4.2, y: 64.8, w: 25.4, h: 8.0 },
      'gauntlet-of-shar': { x: 36.8, y: 64.8, w: 23.0, h: 8.0 },
      'balthazars-lab': { x: 66.8, y: 64.8, w: 26.4, h: 8.0 },
      'circus-of-the-last-days': { x: 4.2, y: 74.4, w: 38.6, h: 8.2 },
      'undercity-ruins': { x: 52.0, y: 74.4, w: 41.2, h: 8.2 },
      'steel-watch-foundry': { x: 4.6, y: 84.6, w: 27.8, h: 10.6 },
      'ansurs-sanctum': { x: 35.0, y: 84.6, w: 30.2, h: 10.6 },
      'temple-of-bhaal': { x: 66.8, y: 84.6, w: 26.4, h: 10.6 },
    },
  },
]
