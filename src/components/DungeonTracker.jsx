...
const DUNGEONS = [
  ...
  },
  {
    ...
    rooms: {
      ...
      'last-light-inn':          { name: 'Last Light Inn',           effect: 'Draw two cards',                                                                        next: ['moonrise-towers'] },
      ...
      'circus-of-the-last-days': { name: 'Circus of the Last Days',  effect: "Create a token that's a copy of one of your tokens",                                    next: [] },
      'undercity-ruins':         { name: 'Undercity Ruins',          effect: 'Create three 1/1 black Skeleton creature tokens',                                       next: [] },
    },
  }
]
