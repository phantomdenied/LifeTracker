...
export const PLANES = [
  ...
  { id: 'academy-tolaria-west',  name: 'Academy at Tolaria West',  set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Dominaria',
  ...
  { id: 'agyrem',               name: 'Agyrem',                   set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Ravnica',
  ...
  { id: 'akoum',                name: 'Akoum',                    set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Zendikar',
    static: 'Players may cast enchantment spells as though they had flash.',
    chaos:  'Destroy target creature that is not enchanted.' },

  { id: 'aretopolis',           name: 'Aretopolis',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ravnica',
  ...
  { id: 'astral-arena',         name: 'Astral Arena',             set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Blind Eternities',
  ...
  { id: 'bant',                 name: 'Bant',                     set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
    static: 'All creatures have exalted.',
    chaos:  'Put a +1/+1 counter on target creature.' },

  { id: 'bloodhill-bastion',    name: 'Bloodhill Bastion',        set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Equilor',
  ...
  { id: 'celestine-reef',       name: 'Celestine Reef',           set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Luvion',
  ...
  { id: 'cliffside-market',     name: 'Cliffside Market',         set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Mercadia',
  ...
  { id: 'edge-of-malacol',      name: 'Edge of Malacol',          set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
  ...
  { id: 'eloren-wilds',         name: 'Eloren Wilds',             set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Shandalar',
  ...
  { id: 'enigma-ridges',        name: 'Enigma Ridges',            set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Ikoria',
    static: 'If a creature you control would untap during your untap step, put two +1/+1 counters on it instead.',
    chaos:  'Untap each creature you control.' },

  { id: 'esper',                name: 'Esper',                    set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
  ...
  { id: 'feeding-grounds',      name: 'Feeding Grounds',          set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
    static: 'Red spells cost {1} less to cast. Green spells cost {1} less to cast.',
    chaos:  'Target creature gets +3/+3 until end of turn.' },

  { id: 'fields-of-summer',     name: 'Fields of Summer',         set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Bant',
    static: 'Whenever a player casts a spell, that player may gain 1 life.',
    chaos:  'You may gain 10 life.' },

  { id: 'furnace-layer',        name: 'Furnace Layer',            set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'New Phyrexia',
  ...
  { id: 'gavony',               name: 'Gavony',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Innistrad',
  ...
  { id: 'ghirapur',             name: 'Ghirapur',                 set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Kaladesh',
    static: 'Artifact spells cost {2} less to cast.',
    chaos:  'Create two 1/1 colorless Thopter artifact creature tokens with flying.' },

  { id: 'glen-elendra',         name: 'Glen Elendra',             set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Lorwyn',
  ...
  { id: 'glimmervoid-basin',    name: 'Glimmervoid Basin',        set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Mirrodin',
  ...
  { id: 'goldmeadow',           name: 'Goldmeadow',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Lorwyn',
  ...
  { id: 'grand-ossuary',        name: 'Grand Ossuary',            set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ravnica',
  ...
  { id: 'grixis',               name: 'Grixis',                   set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
  ...
  { id: 'grove-dreampods',      name: 'Grove of the Dreampods',   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Lorwyn',
  ...
  { id: 'hedron-fields',        name: 'Hedron Fields of Agadeem', set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Zendikar',
  ...
  { id: 'horizon-boughs',       name: 'Horizon Boughs',           set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Lorwyn',
    static: 'All activated abilities cost {2} less to activate.',
    chaos:  'Until end of turn, you may play any number of lands.' },

  { id: 'immersturm',           name: 'Immersturm',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Shandalar',
  ...
  { id: 'inys-haen',            name: 'Inys Haen',                set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'isle-vesuva',          name: 'Isle of Vesuva',           set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Dominaria',
  ...
  { id: 'izzet-steam-maze',     name: 'Izzet Steam Maze',         set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Ravnica',
  ...
  { id: 'jund',                 name: 'Jund',                     set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
  ...
  { id: 'kessig',               name: 'Kessig',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Innistrad',
  ...
  { id: 'ketria',               name: 'Ketria',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ikoria',
  ...
  { id: 'kharasha-foothills',   name: 'Kharasha Foothills',       set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Regatha',
  ...
  { id: 'kilnspire',            name: 'Kilnspire District',       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ravnica',
  ...
  { id: 'krosa',                name: 'Krosa',                    set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Dominaria',
    static: 'All creatures get +2/+2.',
    chaos:  'Untap all creatures. After this phase, there is an additional combat phase.' },

  { id: 'lair-ashen-idol',      name: 'Lair of the Ashen Idol',   set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Unknown',
  ...
  { id: 'lethe-lake',           name: 'Lethe Lake',               set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
    static: 'At the beginning of each players upkeep, that player mills 10 cards.',
    chaos:  'Target player mills 10 cards.' },

  { id: 'littjara',             name: 'Littjara',                  set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Kaldheim',
    static: 'Shapeshifter spells cost {2} less to cast.',
    chaos:  'Create a token that is a copy of target creature.' },

  { id: 'llanowar',             name: 'Llanowar',                  set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Dominaria',
    static: 'All creatures have "{T}: Add {G}."',
    chaos:  'Add {G} for each creature you control.' },

  { id: 'megaflora-jungle',     name: 'Megaflora Jungle',          set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Alara',
  ...
  { id: 'minamo',               name: 'Minamo',                   set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Kamigawa',
    static: 'Whenever a player casts a spell, that player may draw a card.',
    chaos:  'You may tap or untap target permanent.' },

  { id: 'mirrored-depths',      name: 'Mirrored Depths',           set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Mirrodin',
  ...
  { id: 'mount-keralia',        name: 'Mount Keralia',            set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Regatha',
  ...
  { id: 'murasa',               name: 'Murasa',                   set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Zendikar',
  ...
  { id: 'naar-isle',            name: 'Naar Isle',                set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
  ...
  { id: 'naktamun',             name: 'Naktamun',                  set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Amonkhet',
    static: 'Each creature that dies is exiled instead.',
    chaos:  'Create a 4/4 white Angel Warrior creature token with vigilance.' },

  { id: 'naya',                 name: 'Naya',                     set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Alara',
  ...
  { id: 'nephalia',             name: 'Nephalia',                  set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Innistrad',
  ...
  { id: 'new-argive',           name: 'New Argive',                set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
    static: 'White creature spells cost {2} less to cast.',
    chaos:  'Create a 3/3 white Golem artifact creature token.' },

  { id: 'norns-dominion',       name: "Norn's Dominion",          set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'New Phyrexia',
  ...
  { id: 'norns-seedcore',       name: "Norn's Seedcore",           set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'New Phyrexia',
  ...
  { id: 'nyx',                  name: 'Nyx',                       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Theros',
  ...
  { id: 'onakke-catacomb',      name: 'Onakke Catacomb',          set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Shandalar',
  ...
  { id: 'orochi-colony',        name: 'Orochi Colony',            set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Kamigawa',
  ...
  { id: 'orzhova',              name: 'Orzhova',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ravnica',
  ...
  { id: 'otaria',               name: 'Otaria',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
  ...
  { id: 'paliano',              name: 'Paliano',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Fiora',
  ...
  { id: 'panopticon',           name: 'The Panopticon',           set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Mirrodin',
    static: 'When you planeswalk to The Panopticon, draw a card.',
    chaos:  'Draw a card.' },

  { id: 'pools-of-becoming',    name: 'The Pools of Becoming',    set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Blind Eternities',
  ...
  { id: 'prahv',                name: 'Prahv',                     set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ravnica',
  ...
  { id: 'quicksilver-sea',      name: 'Quicksilver Sea',           set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Mirrodin',
    static: 'Players may cast nonland cards from the top of their libraries.',
    chaos:  'Scry 4.' },

  { id: 'ravens-run',           name: "Raven's Run",              set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Shadowmoor',
    static: 'All creatures have protection from the color of their controllers choice.',
    chaos:  'Put a +1/+1 counter on each creature you control.' },

  { id: 'riptide-island',       name: 'Riptide Island',            set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
    static: 'Wizard spells cost {2} less to cast.',
    chaos:  'Return target creature to its owners hand. If it is a Wizard, draw a card.' },

  { id: 'sanctum-sera',         name: 'Sanctum of Serra',         set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: "Serra's Realm",
    static: 'All creatures have vigilance.',
    chaos:  'Destroy all attacking creatures.' },

  { id: 'sea-of-sand',          name: 'Sea of Sand',              set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Rabiah',
  ...
  { id: 'selesnya-loft-gardens', name: 'Selesnya Loft Gardens',   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ravnica',
  ...
  { id: 'shiv',                 name: 'Shiv',                     set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Dominaria',
    static: 'Creatures you control have "{R}: This creature gets +1/+0 until end of turn."',
    chaos:  'Create a 5/5 red Dragon creature token with flying.' },

  { id: 'skybreen',             name: 'Skybreen',                 set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Lorwyn',
  ...
  { id: 'sokenzan',             name: 'Sokenzan',                 set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Kamigawa',
  ...
  { id: 'spatial-merging',      name: 'Spatial Merging',          set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
  ...
  { id: 'stairs-to-infinity',   name: 'Stairs to Infinity',       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Xerex',
  ...
  { id: 'stensia',              name: 'Stensia',                  set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Innistrad',
  ...
  { id: 'strixhaven',           name: 'Strixhaven',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Arcavios',
  ...
  { id: 'stronghold-furnace',   name: 'Stronghold Furnace',       set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Rath',
  ...
  { id: 'takenuma',             name: 'Takenuma',                 set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Kamigawa',
  ...
  { id: 'talon-gates',          name: 'Talon Gates',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
  ...
  { id: 'tazeem',               name: 'Tazeem',                   set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Zendikar',
    static: 'Landfall -- Whenever a land enters the battlefield, its controller draws a card.',
    chaos:  'Target player draws 3 cards.' },

  { id: 'tember-city',          name: 'Tember City',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Shandalar',
  ...
  { id: 'ten-wizards-mountain', name: 'Ten Wizards Mountain',     set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'the-aether-flues',     name: 'The Aether Flues',          set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Kaladesh',
  ...
  { id: 'the-caldaia',          name: 'The Caldaia',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'New Capenna',
    static: 'Artifact creatures you control get +1/+1.',
    chaos:  'Create a 4/4 colorless Construct artifact creature token.' },

  { id: 'the-dark-barony',      name: 'The Dark Barony',           set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
    static: 'Whenever a player casts a white spell, that player loses 2 life.',
    chaos:  'Each other player discards a card.' },

  { id: 'the-eon-fog',          name: 'The Eon Fog',               set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
    static: 'Players skip their untap steps.',
    chaos:  'Untap all permanents you control.' },

  { id: 'the-fertile-lands',    name: 'The Fertile Lands of Saulvinia', set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'the-fourth-sphere',    name: 'The Fourth Sphere',        set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Phyrexia',
  ...
  { id: 'the-golden-city',      name: 'The Golden City of Orazca', set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ixalan',
  ...
  { id: 'the-great-aerie',      name: 'The Great Aerie',           set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ikoria',
    static: 'Creatures with flying get +2/+2.',
    chaos:  'Create two 2/2 white Bird creature tokens with flying.' },

  { id: 'the-great-forest',     name: 'The Great Forest',          set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Lorwyn',
  ...
  { id: 'the-hippodrome',       name: 'The Hippodrome',            set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
    static: 'Creatures cannot block.',
    chaos:  'After this phase, there is an additional combat phase.' },

  { id: 'the-maelstrom',        name: 'The Maelstrom',             set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Alara',
  ...
  { id: 'the-pit',              name: 'The Pit',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'the-western-cloud',    name: 'The Western Cloud',         set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'the-wilds',            name: 'The Wilds',                 set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'the-zephyr-maze',      name: 'The Zephyr Maze',           set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
    static: 'Only creatures with flying can attack.',
    chaos:  'Each creature gains flying until end of turn.' },

  { id: 'towashi',              name: 'Towashi',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Kamigawa',
  ...
  // Phenomena
  { id: 'chaotic-aether',       name: 'Chaotic Aether',           set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
  ...
  { id: 'interplanar-tunnel',   name: 'Interplanar Tunnel',       set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
  ...
  { id: 'morphic-tide',         name: 'Morphic Tide',             set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
  ...
  { id: 'mutual-epiphany',      name: 'Mutual Epiphany',          set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
    static: 'When you encounter Mutual Epiphany, each player draws 4 cards.',
    chaos:  null },

  { id: 'planewide-disaster',   name: 'Planewide Disaster',       set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
    static: 'When you encounter Planewide Disaster, destroy all permanents.',
    chaos:  null },

  { id: 'reality-shaping',      name: 'Reality Shaping',          set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
    static: 'When you encounter Reality Shaping, each player may put a permanent card from their hand onto the battlefield.',
    chaos:  null },

  { id: 'time-distortion',      name: 'Time Distortion',          set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
