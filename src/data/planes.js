...
export const PLANES = [
  ...
  { id: 'glimmerpost-ravnica',name: 'Glimmerpost Ravnica',          set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Ravnica',
  ...
  { id: 'llanowar-wastes-plane', name: 'Llanowar Wastes',           set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Dominaria',
  ...
  { id: 'minamo-plane',       name: 'Minamo',                       set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Kamigawa',
  ...
  { id: 'onakke-pit',         name: 'Onakke Catacomb',              set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Shandalar',
  ...
  { id: 'academy-tolaria',    name: 'Academy at Tolaria West',      set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Dominaria',
  ...
  { id: 'kessig',             name: 'Kessig',                       set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Innistrad',
  ...
  { id: 'ophiomancer-den',    name: "Ophiomancer's Den",            set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Unknown',
  ...
  { id: 'sanctum-serra',      name: 'Sanctum of Serra',             set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: "Serra Realm",
    static: 'All creatures have vigilance.',
    chaos:  'Destroy all attacking creatures.' },

  { id: 'fourth-sphere',      name: 'The Fourth Sphere',            set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Phyrexia',
  ...
  { id: 'trail-of-mystery',   name: 'Trail of Mystery',             set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Tarkir',
  ...
  { id: 'stensia',            name: 'Stensia',                      set: 'PC1', scryfallSet: 'ohop', type: 'plane', world: 'Innistrad',
  ...
  { id: 'bolas-meditation',   name: "Bolas's Meditation Realm",     set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Alara',
  ...
  { id: 'disk-kaervek',       name: 'Disk of Kaervek',              set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Zhalfir',
    static: 'Spells cost an additional {1} to cast for each other spell cast this turn.',
    chaos:  'Destroy target permanent.' },

  { id: 'echo-city',          name: 'Echo City',                    set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Ravnica',
  ...
  { id: 'ergamon',            name: 'Ergamon',                      set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'fabacin',            name: 'Fabacin',                      set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'grixis',             name: 'Grixis',                       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Alara',
  ...
  { id: 'havengul-lab',       name: 'Havengul Laboratory',          set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Innistrad',
  ...
  { id: 'kugeln',             name: 'Kugeln',                       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'luvion',             name: 'Luvion',                       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Alara',
    static: "Creatures without flying can't attack.",
    chaos:  'Until end of turn, target creature gains flying and gets +3/+3.' },

  { id: 'mount-keld',         name: 'Mount Keld',                   set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
  ...
  { id: 'norns-marrow',       name: "Norn's Marrow",                set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'New Phyrexia',
  ...
  { id: 'shivan-gorge',       name: 'Shivan Gorge',                 set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
  ...
  { id: 'skarg',              name: 'Skarg',                        set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Equilor',
    static: 'All creatures get -2/-2. Creature tokens get an additional -2/-2.',
    chaos:  'Target creature gets +6/+6 until end of turn.' },

  { id: 'tukataongue',        name: 'Tukataongue Thicket',          set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Alara',
  ...
  { id: 'urborg',             name: 'Urborg',                       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
    static: 'All lands are Swamps in addition to their other types.',
    chaos:  'Paralyze target creature.' },

  { id: 'vesuva',             name: 'Vesuva',                       set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Dominaria',
    static: 'Lands you control have "{T}: Add one mana of any color."',
    chaos:  'Target land you control becomes a copy of any land on the battlefield until end of turn.' },

  { id: 'wildfire-plains',    name: 'Wildfire Plains',              set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Alara',
    static: 'Whenever a player taps a Mountain for mana, that player adds {G} to their mana pool.',
    chaos:  'Destroy all nonbasic lands.' },

  { id: 'xerex',              name: 'Xerex',                        set: 'PC2', scryfallSet: 'opc2', type: 'plane', world: 'Unknown',
  ...
  { id: 'nexus-multiverse',   name: 'Chaotic Aether',               set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
  ...
  { id: 'temporal-medium',    name: 'Time Distortion',              set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
    static: 'When you encounter Time Distortion, reverse the game turn order.',
    chaos:  null },

  { id: 'untimely-interference', name: 'Mutual Epiphany',           set: 'PC2', scryfallSet: 'opc2', type: 'phenomenon', world: null,
    static: 'When you encounter Mutual Epiphany, each player draws 4 cards.',
    chaos:  null },

  // -- Commander Legends: Battle for Baldur's Gate (CLB) --------------------
  { id: 'avernus',            name: 'Avernus',                      set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'The Nine Hells',
  ...
  { id: 'baldurs-gate',       name: "Baldur's Gate",                set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Faer-n',
  ...
  { id: 'castle-ravenloft',   name: 'Castle Ravenloft',             set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Barovia',
  ...
  { id: 'dis',                name: 'Dis',                          set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'The Nine Hells',
  ...
  { id: 'elturel',            name: 'Elturel',                      set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Faer-n',
  ...
  { id: 'limbo',              name: 'Limbo',                        set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Outer Planes',
  ...
  { id: 'mechanus',           name: 'Mechanus',                     set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Outer Planes',
  ...
  { id: 'menzoberranzan',     name: 'Menzoberranzan',               set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Underdark',
  ...
  { id: 'minauros',           name: 'Minauros',                     set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'The Nine Hells',
  ...
  { id: 'mount-celestia',     name: 'Mount Celestia',               set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Outer Planes',
    static: 'Creatures you control have lifelink.',
    chaos:  'You gain life equal to your devotion to white.' },

  { id: 'nine-hells',         name: 'The Nine Hells',               set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'The Nine Hells',
    static: 'Whenever a player casts a spell, that player loses 1 life.',
    chaos:  'Gain 6 life.' },

  { id: 'phlegethos',         name: 'Phlegethos',                   set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'The Nine Hells',
  ...
  { id: 'sigil',              name: 'Sigil',                        set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Outer Planes',
  ...
  { id: 'river-styx',         name: 'The River Styx',               set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'The Nine Hells',
    static: "Spells cost {1} more to cast for each card in their controllers graveyard.",
    chaos:  "Each player exiles their graveyard." },

  { id: 'waterdeep',          name: 'Waterdeep',                    set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Faer-n',
  ...
  { id: 'ysgard',             name: 'Ysgard',                       set: 'CLB', scryfallSet: 'oclb', type: 'plane', world: 'Outer Planes',
